...
public class UserController {
	...
	/*@RequestMapping(value="ck", method=RequestMethod.GET)	// �ߺ�üũ
	public String read(@RequestParam(value="uid")String uid, Model model) throws Exception{ //defaultValue �� String�� ���� �� �ִ�.
		System.out.println("�Ѿ���¾��̵�:"+uid);
